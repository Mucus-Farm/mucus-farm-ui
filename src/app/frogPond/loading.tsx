...
export default function Loading() {
  return (
    <section className='relative min-h-screen flex flex-col bg-mc-rose-200 px-3 py-6 xl:px-8 xl:py-8 2xl:px-10 2xl:py-10 pt-[75px] xl:pt-[75px] 2xl:pt-[75px]'>
      <SkeletonLayout faction='FROG' />
