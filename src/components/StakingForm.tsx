      ...
      <div className={`absolute transition-all duration-200 ease-linear ${showSlippageDropdown ? 'scale-y-100 z-100 opacity-100' : 'scale-y-0 -z-1 opacity-0'} mt-1 top-full origin-top right-0 px-4 py-2 rounded-xl bg-mc-rose-300 shadow-[0_2px_44px_0_rgba(0,0,0,0.15)]`}>
        ...
        <div className='flex gap-x-2 mt-1'>
          ...
          <div className='flex justify-center items-center w-16 h-8 rounded-md border border-mc-mahogany-300/60 text-mc-mahogany-300 text-center bg-mc-rose-400'>
            <NumberInput onKeyDown={handleKeyDown} name='slippage' register={register} className='text-sm text-center h-8 w-8 pl-[2px] pb-[0.25px] text-mc-mahogany-300/80 placeholder-mc-mahogany-300/80'/>
        ...
        <div className='flex gap-x-10'>
          <div className='flex flex-col p-6 rounded-xl text-mc-mahogany-300 bg-mc-rose-300'>
            ...
            <div className='flex flex-col gap-y-2'>
              ...
              <div className='flex justify-between items-center rounded-xl px-4 h-16 bg-mc-mahogany-200'>
                <div className='flex flex-col'>
                  <NumberInput name='deposit' register={register} />
                  <div className={`text-xs text-white transition-all ease-linear duration-200 ${/^(0|[1-9][0-9]*)$/.test(deposit) ? 'opacity-100 h-auto' : 'opacity-0 h-0'}`}>
            ...
            <div className='flex flex-col gap-y-2 mt-8'>
              ...
              <div className='flex justify-between items-center rounded-xl px-4 h-16 bg-mc-green-100'>
                <div className='flex flex-col'>
          ...
          <div className='flex flex-col text-mc-mahogany-300'>
            <div className='bg-mc-rose-300 p-6 rounded-xl'>
              <h3 className='text-lg font-bold tracking-tight'>WITHDRAW</h3>
              <p className='text-md'>AMOUNT</p>
              <div className='flex justify-center items-center rounded-xl px-4 h-16 bg-mc-mahogany-200 mt-2'>
                <NumberInput name='deposit' register={register} />
                <div className={`text-xs text-white transition-all ease-linear duration-200 ${/^(0|[1-9][0-9]*)$/.test(withdraw) ? 'opacity-100 h-auto' : 'opacity-0 h-0'}`}>
            ...
            <p className='text-lg text-center whitespace-nowrap text-mc-mahogany-300 mt-6'>
              YOU MAY QUALIFY FOR A FREE MINT
            </p>
            <Button className='bg-white/50 border border-white py-4 text-2xl text-mc-mahogany-300 w-full mt-1'>
              MUCUS GENERATOR
            </Button>
          </div>
        </div> 
