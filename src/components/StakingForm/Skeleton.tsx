...
export const Deposit = ({ faction }: DepositProps) => {
  return (
    <div className={`flex-grow flex flex-col p-4 rounded-xl ${fcp[faction].text} ${fcp[faction].bg}`}>
      ...
      <div className='flex-grow flex items-end'>
        <div className={`h-9 w-full ${fcp[faction].darkBg} rounded-lg animate-pulse`} /> 
      </div> 
    </div>
  )
}
...
export const Withdraw = ({ faction }: WithdrawProps) => {
  return (
    <div className={`w-[400px] flex flex-col ${fcp[faction].text}`}>
      <div className={`${fcp[faction].bg} p-4 rounded-xl`}>
        ...
        <div className='flex justify-end gap-x-3 mt-4 2xl:mt-6'>
          <div className={`h-9 w-12 ${fcp[faction].darkBg} rounded-lg animate-pulse`} />
          <div className={`h-9 w-full ${fcp[faction].darkBg} rounded-lg animate-pulse`} />
        </div>
      </div>
