...
const IconHolder = ({ children, href, onClick }: IconHolderProps) => (
  <Button className='px-6 py-2 border-2 border-white rounded-lg bg-mc-brown-300/90 hover:bg-mc-brown-300/80 active:bg-mc-brown-300' href={href} onClick={onClick} >
    {children}
  </Button>
)
